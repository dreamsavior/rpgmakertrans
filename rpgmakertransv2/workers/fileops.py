...
def getmtime(path):
    return os.path.getmtime(winescape(path))


def pathexists(path):
    return os.path.exists(winescape(path))


def isfile(path):
    return os.path.isfile(winescape(path))


def mkdir(path):
    os.mkdir(winescape(path))
...
def isdir(path):
    return os.path.isdir(winescape(path))


def walk(path):
    return os.walk(winescape(path))
