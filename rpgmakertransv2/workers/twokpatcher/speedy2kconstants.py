...
contextNames = {
    ...
    'Skill': 'skillAttr',
    'Item': 'itemAttr',
    'Condition': 'conditionDataAttr',
    'Monster': 'monsterAttr',
    'MonsterParty': 'monsterPartyAttr',
    'Attribute': 'attributeDataAttr',
}
...
rtsubsections = {
    ...
    'SkillData': 'skillAttr',
    'ItemData': 'itemAttr',
    'MonsterData': 'monsterAttr',
    'MonsterParties': 'monsterPartyAttr',
    'attributeData': 'attributeDataAttr',
    'ConditionData': 'conditionDataAttr',
    'StringData': 'stringData',
    'CommonEventData': 'Dialogue'}

scriptContainerSpecialKeys = {
    'commonEventContainer': (
        names['ComEventScriptLength'],
        names['ComEventScript']),
    'monsterBattleEventPageContainer': (
        names['MonsterBattleScriptLength'],
        names['MonsterBattleScript']),
    'mapEventPageContainer': (
        names['MapScriptLength'],
        names['MapScript'])}
...
for name, termnames, context in scriptStartCollects:
    scriptSchemaStartCollectsDict[opcodes[name]] = set(
        [opcodes[x] for x in termnames]), context
...
ldbschemaDict[
    blockTypes['Strings']] = (
        'stringData', {
            'defaultStringData': stringDataDict})
